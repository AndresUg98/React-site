...
import { PlusIcon, CheckIcon } from "@heroicons/react/24/solid"; //Añadiendiendo iconos con hero icons (https://heroicons.com/)
...
const Card = (data) => {
  ...
  const addProductsToCart = (event, productData) => {
    ...
    //almacenar el producto al array vacio
  ...
  return (
    ...
    >
      <figure className="relative mb-2 w-full h-4/5">
        ...
        {/* render icuon allow us to avoid adding the same product twice */}
